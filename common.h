...
public:
	...
	virtual unsigned short read(std::list<EventEntry*>* event_list, std::list<std::string>* event_line_list=NULL)=0;
};
...
public:
	...
	virtual unsigned short read(std::list<EventEntry*>* event_list, std::list<std::string>* event_line_list=NULL);
};
...
public:
	...
	unsigned short read(std::list<EventEntry*>* event_list, std::list<std::string>* event_line_list=NULL);
};
