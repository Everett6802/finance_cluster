...
const unsigned short RET_WARN_CLUSTER_NOT_SINGLE = RET_WARN_BASE + 4;
const unsigned short RET_WARN_FILE_TRANSFER_IN_PROCESS = RET_WARN_BASE + 5;
const unsigned short RET_WARN_FILE_TRANSFER_RESOURCE_BUSY = RET_WARN_BASE + 6;
const unsigned short RET_WARN_REMOTE_FILE_TRANSFER_FAILURE = RET_WARN_BASE + 7;
