...
SOURCES := msg_dumper_wrapper.cpp finance_cluster.cpp common_definition.cpp common_function.cpp common_class.cpp node_base.cpp leader_node.cpp follower_node.cpp cluster_mgr.cpp  leader_send_thread.cpp node_recv_thread.cpp keepalive_timer_task.cpp
OBJS := $(SOURCES:.cpp=.o)
